...
BOT_TOKEN = environ.get('BOT_TOKEN', "6755237545:AAFUOwxsKlbqP6fqrzSkjboPw4Dl04oLT-g")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002090780480').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6245830027').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '1002093400909')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001805234418')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://devilboy6137:mikey_kun_781_@cluster0.hlm7xll.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "devilboy6137")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
VERIFY = bool(environ.get('VERIFY', False))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'publicearn.com')
SHORTLINK_API = environ.get('SHORTLINK_API', 'a9f04899e7861f97eef19a105f34005bd320137c')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "10")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/RT_Anime_Group')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/New_Animes_Dubbed_Hindi')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/New_Animes_Dubbed_Hindi')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello Nanbha and Nanbis ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ''))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'RT_ANIME_GROUP')
...
NO_PORT = bool(environ.get('NO_PORT', ))
APP_NAME = None
if 'DYNO' in environ:
    ON_HEROKU = True
...
URL = "https://planned-mickie-mikeykun-fd7ba646.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://planned-mickie-mikeykun-fd7ba646.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://planned-mickie-mikeykun-fd7ba646.koyeb.app/".format(FQDN)
else:
    URL = "https://planned-mickie-mikeykun-fd7ba646.koyeb.app/".format(FQDN)
